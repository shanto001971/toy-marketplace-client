    ...
    return (
        <div className="">
            ...
            <div className='my-20  lg:flex justify-between'>
                ...
                <div className="p-10 lg:w-1/2 h-60 bg-no-repeat bg-cover rounded-md" style={{
                    backgroundImage: `url("https://s.alicdn.com/@sc04/kf/Hf7b522a8340c4f77910a23640988fe13e.jpg_300x300.jpg")`
                }}>
                    <div className="">
